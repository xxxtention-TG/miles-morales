...
def get_reply_markup(query):
    buttons = [[
        InlineKeyboardButton('𝖬𝗈𝗏𝗂𝖾𝗌 𝖧𝗎𝖻', url='t.me/movieshub_group'),
        InlineKeyboardButton('𝖬𝗈𝗏𝗂𝖾𝗌 𝖧𝗎𝖻', url='t.me/movies_hub66')
        ],[
        InlineKeyboardButton('𝖲𝖾𝗋𝗂𝖾𝗌 𝖧𝗎𝖻', url='t.me/series_hub1')
        ],[
